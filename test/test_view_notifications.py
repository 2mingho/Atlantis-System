...
class TestViewnotifications():
  ...
  def test_viewnotifications(self):
    ...
    self.driver.find_element(By.ID, "notifDropdown").click()
    self.driver.find_element(By.LINK_TEXT, "See all notifications").click()
