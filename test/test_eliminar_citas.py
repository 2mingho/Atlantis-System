...
class TestEliminarcitas():
  ...
  def test_eliminarcitas(self):
    self.driver.get("http://localhost/citas_medicas/login.php")
    self.driver.set_window_size(1253, 727)
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".nav-item:nth-child(2) p").click()
    self.driver.find_element(By.LINK_TEXT, "Mostrar").click()
    self.driver.find_element(By.CSS_SELECTOR, ".odd:nth-child(3) .fa").click()
    self.driver.find_element(By.LINK_TEXT, "Eliminar").click()
